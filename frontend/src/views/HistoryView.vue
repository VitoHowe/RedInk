<template>
  <div class="container" style="max-width: 1200px">
    ...
    <div v-else class="gallery-grid">
      <div v-for="record in records" :key="record.id" class="gallery-card">
        <!-- Card Cover -->
        <div class="card-cover" @click="viewImages(record.id)">
          ...
          <div class="card-overlay">
            ...
            <button
              ...
              @click.stop="loadRecord(record.id)"
            >
              编辑
            </button>
          </div>
    ...
    <div v-if="viewingRecord" class="modal-fullscreen" @click="closeGallery">
      <div class="modal-body" @click.stop>
          ...
          <div style="flex: 1">
            ...
            <div class="title-section">
              <h3
                class="modal-title"
                :class="{
                  collapsed: !titleExpanded && viewingRecord.title.length > 80,
                }"
              >
                {{ viewingRecord.title }}
              </h3>
            ...
            >
              <span
                >{{ viewingRecord.outline.pages.length }} 张图片 ·
                {{ formatDate(viewingRecord.updated_at) }}</span
              >
              <button
        ...
        <div class="modal-gallery-grid">
          <div
            v-for="(page, idx) in viewingRecord.outline.pages"
            :key="idx"
          ...
          >
            ...
            <div class="modal-img-preview">
              <!-- 如果有图片则显示图片 -->
              <img
                v-if="viewingRecord.images.generated[idx]"
                :src="`/api/images/${viewingRecord.images.task_id}/${viewingRecord.images.generated[idx]}`"
                loading="lazy"
                decoding="async"
              />
              <!-- 否则显示文字内容 -->
            ...
            >
              ...
              <span
                ...
                @click="downloadImage(viewingRecord.images.generated[idx], idx)"
              >
                下载
              </span>
            </div>
    ...
    <div
      ...
      @click="showOutlineModal = false"
    >
      <div class="outline-modal-content" @click.stop>
        <div class="outline-modal-header">
          <h3>完整大纲</h3>
          <button class="close-icon" @click="showOutlineModal = false">
            ×
          </button>
        </div>
        <div class="outline-modal-body">
          ...
          >
            <div class="outline-page-card-header">
              ...
              <span class="page-type-badge" :class="page.type">{{
